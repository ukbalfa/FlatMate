  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-[#F97316]/[0.07] blur-[150px]" />
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] rounded-full bg-[#84CC16]/[0.05] blur-[120px]" />
        <div className="absolute top-1/3 right-1/4 w-[300px] h-[300px] rounded-full bg-[#38BDF8]/[0.04] blur-[80px]" />
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 flex flex-col items-center px-4 w-full max-w-5xl">
        ...
        >
          <Link
            href="/login"
            className="group px-6 py-3 rounded-full text-sm font-semibold text-white bg-gradient-to-r from-[#F97316] to-[#FBBF24] hover:shadow-[0_0_30px_-5px_rgba(249,115,22,0.4)] transition-all duration-300 flex items-center gap-2 w-full sm:w-auto justify-center"
          >
      ...
      >
        <div className="relative rounded-2xl border border-white/[0.08] bg-[#0A0A0A]/80 backdrop-blur-sm overflow-hidden shadow-2xl shadow-black/50">
          {/* Window chrome */}
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.05]">
            ...
            <div className="flex-1 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white/[0.03] border border-white/[0.05] text-[10px] text-white/30">
          ...
          <div className="p-4 md:p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              {[
                ...
                <div
                  key={i}
                  className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 transition-colors"
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] text-white/40 uppercase tracking-wider">{stat.label}</span>
                    <div className={`p-1.5 rounded-lg bg-gradient-to-br ${stat.color} to-transparent/20`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div className="lg:col-span-2 p-5 rounded-xl bg-white/[0.02] border border-white/[0.05]">
                ...
                <div className="h-32 flex items-end gap-1.5">
                  {[40, 65, 45, 80, 55, 90, 70, 50, 75, 60, 85, 45].map((h, i) => (
                    <div
                      key={i}
                      className="flex-1 rounded-t-sm bg-gradient-to-t from-[#F97316]/30 to-[#FBBF24]/10 hover:from-[#F97316]/50 hover:to-[#FBBF24]/30 transition-all duration-300"
                      style={{ height: `${h}%` }}
                    />
                  ))}
                </div>
